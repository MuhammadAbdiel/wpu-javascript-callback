...
//     fetch('http://www.omdbapi.com/?apikey=8fc1c0ef&s=' + inputKeyword.value)
...
//                     fetch('http://www.omdbapi.com/?apikey=8fc1c0ef&i=' + imdbid)
//                         .then(response => response.json())
//                         .then(response => {
...
function getMovies(keyword) {
    return fetch('http://www.omdbapi.com/?apikey=8fc1c0ef&s=' + keyword)
        .then(response => {
            if (!response.ok) {
...
function getMovieDetail(imdbid) {
    return fetch('http://www.omdbapi.com/?apikey=8fc1c0ef&i=' + imdbid)
        .then(response => response.json())
        .then(movie => movie);
}
